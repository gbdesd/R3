...
WebPage=https://raw.githubusercontent.com/caddyserver/dist/master/welcome/index.html
CaddyConfig=https://raw.githubusercontent.com/gbdesd/Rail/main/etc/Caddyfile
XRayConfig=https://raw.githubusercontent.com/gbdesd/Rail/main/etc/xray.json
